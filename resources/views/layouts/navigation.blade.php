<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('item.index')" :active="request()->routeIs('item.index') || request()->routeIs('item.edit') || request()->routeIs('item.create') || request()->routeIs('item.show') || request()->routeIs('attribute.edit') || request()->routeIs('attribute.create') || request()->routeIs('attribute.show')">
                        {{ __('Item Catalog') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('building.index')" :active="request()->routeIs('building.index') || request()->routeIs('building.edit') || request()->routeIs('building.create') || request()->routeIs('building.show') || request()->routeIs('room.edit') || request()->routeIs('room.create') || request()->routeIs('room.show') || request()->routeIs('appliance.edit') || request()->routeIs('appliance.create') || request()->routeIs('appliance.show')">
                        {{ __('Building Model') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('item.index')" :active="request()->routeIs('item.index') || request()->routeIs('item.edit') || request()->routeIs('item.create') || request()->routeIs('item.show') || request()->routeIs('attribute.edit') || request()->routeIs('attribute.create') || request()->routeIs('attribute.show')">
                {{ __('Item Catalog') }}
            </x-responsive-nav-link>
